...
// //   },
// //   { label: "Packages", icon: discount, path: "/agent-dashboard/packages" },
// //   {
...
// //   return (
// //     <div className="w-[256px] min-h-[1200px] bg-white shadow-md px-[28px] py-6 flex flex-col font-[Lato]">
// //       {/* Logo */}
...
// //           />
// //         ) : (
// //           <div className="w-20 h-20 rounded-full bg-gray-100 border border-gray-300" />
// //         )}
// //       </div>
...
// //         <hr className="w-[70%] mx-auto border-t border-gray-300 mb-10" />
// //         <div
// //           className="bg-[#F05A28] text-white rounded-xl px-4 py-4"
// //           style={{ width: "208px", height: "252px" }}
// //         >
// //           <div className="text-[11px] font-medium">Save Huge with</div>
// //           <div className="text-lg font-bold mb-1 leading-snug">
// //             British Airways
// //           </div>
// //           <p className="text-[11px] leading-snug mb-3">
// //             Book Flights from India to the UK with British Airways & Enjoy Up to
// //             INR 2500 OFF
// //           </p>
...
// //         Powered by <span className="font-semibold text-black">WeeFly</span>
// //       </div>
// //     </div>
// //   );
// // }
...
//     path: "/agent-dashboard/analytics",
//   },
//   { label: "Packages", icon: discount, path: "/agent-dashboard/agentPackages" },
//   {
//     label: "Support Ticketing",
//     icon: support,
//     path: "/agent-dashboard/support",
...
//   return (
//     <div className="w-[256px] min-h-[800px] mr-5 bg-white shadow-md px-[28px] py-6 flex flex-col font-[Lato]">
//       {/* Logo */}
//       <div className="flex justify-center mb-6">
//         {agent.logo ? (
//           <img
...
//       <div className="mt-4">
//         <button
//           onClick={() => alert("Switched to user")}
...
//                 </div>
//                 <p className="text-[11px] leading-snug mb-3">
//                   Book Flights from India to the UK with British Airways & Enjoy
//                   Up to INR 2500 OFF
//                 </p>
//                 <div className="bg-white text-[#F05A28] text-xs font-semibold px-3 py-[5px] rounded-full inline-flex items-center gap-1">
//                   WEEFLY247
            ...
            {Array.from({ length: 5 }).map((_, index) => (
              <SwiperSlide key={index}>
                <div className="bg-[#F05A28] text-white rounded-xl px-4 py-4 h-full">
                  ...
                  <p className="text-[11px] leading-snug mb-3">
                    Book Flights from India to the UK with British Airways &
                    Enjoy Up to INR 2500 OFF
                  </p>
                  <div className="bg-white text-[#F05A28] text-xs font-semibold px-3 py-[5px] rounded-full inline-flex items-center gap-1">
                    WEEFLY247
                    <svg
