...
function TravelersDetails() {
	...
	const handleTravellerChange = (field, value) => {
		...
		if (field === 'age') {
			...
			].Name.NamePartList.NamePart[0] = value
		} else if (field === 'dateOfBirth') {
			updatedTravellers[
				currentTravellerIndex
			].CustomSupplierParameterList.CustomSupplierParameter[0].Value =
				value
		}
	...
	const handleContactChange = (field, value) => {
		setContactDetails(prev => {
			...
			if (field === 'title') {
				...
				updated.HomePhone[phoneField] = value
			}
		...
		if (checked) {
			setBillingDetails(prev => ({
				...
				Name: {
					...
					NamePartList: {
						NamePart: [
							...contactDetails.Name.NamePartList.NamePart,
						],
					},
				},
					...
					<div className='max-w-[656px] w-full'>
						...
						{currentStep <= totalTravellers && (
							<div className='w-full bg-white rounded-md p-6 mt-6 font-sans'>
								...
								<p className='text-sm text-gray-500 mb-3'>
									{t(
										'traveller-details.save-details.description'
									)}
								</p>
								<label className='flex items-start gap-2'>
									<input
									...
									<span className='text-sm'>
										{t(
											'traveller-details.save-details.term'
										)}
									</span>
								</label>
							</div>
