...
export default function ReviewYourBooking() {
  ...
  const handleProcessDetails = async () => {
    ...
    if (response.ok) {
      ...
      console.log(res);
     const seatOptions = res.requiredParameterList[0].RequiredParameter[15].DisplayText[0];
     const LuggageOptions = res.requiredParameterList[0].RequiredParameter[16].DisplayText[0];
