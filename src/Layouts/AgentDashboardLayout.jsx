...
// //               <p className="text-[20px] font-semibold">{activeItem}</p>
// //             </div>
...
//         <div className="w-full px-6 py-4">
//           <div className="flex justify-between items-start w-full relative">
//             {/* Left: Page Title + Search + Icons Grouped */}
...
//                 type="text"
//                 placeholder="🔍 Search here..."
//                 className="w-[484px] h-[41px] px-4 py-2 rounded-md bg-gray-200 text-sm outline-none"
//               />

//               {/* Icons slightly right */}
...
//             {/* Right: Profile slightly left */}
//             <div className="mr-16">
//               {" "}
//               {/* Reduced margin for slight left shift */}
//               <div className="flex items-center gap-2 border px-3 py-[6px] rounded-md shadow-sm bg-white min-w-[160px]">
//                 <img
//                   src={ProfilePic}
//                   alt="Profile"
